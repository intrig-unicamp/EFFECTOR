...
###################################
    ...
    net.addLink(s2, s1, 1, 10)  # initial link parameter default according to mininet
...
##############################
    ...
    folder = str(fol)+'_'+str(nett) +'_'+ str(host)+ '_' + str(algo)+ '_' + str(prot)+'_' + str(sertype)
    ...
    if prot=='tcp':
       test_dict['quic']='off'
       test_dict['url']='https://www.godashbed.org/full-sintel/sintel_enc_x264_dash.mpd'
    else:
       test_dict['quic']='on'
       test_dict['url']='https://www.godashbed.org:4444/full-sintel/sintel_enc_x264_dash.mpd'
...
def pcap(mod, host, algo, nett, prot, sertype,fol):
	...
	os.system('sudo tcpdump -i s1-eth10 -U -w  /home/raza/Downloads/goDASH/godash/data/'+str(fol)+'_'+str(nett) +'_'+ str(host)+ '_' + str(algo)+ '_' + str(prot)+'_' + str(sertype)+'/h1_ap.pcap')
...
def player(mod, client, host, algo, nett, prot, sertype,fol):
     ...
     client.cmd('cd /home/raza/Downloads/goDASH/godash && ./godash -config ./config/configure.json >/home/raza/Downloads/goDASH/godash/data/'+str(fol)+'_'+str(nett) +'_'+ str(host)+ '_' + str(algo)+ '_' + str(prot)+'_' + str(sertype)+'/h_'+str(client)+'.txt && echo ....Streaming done_' + str(client))

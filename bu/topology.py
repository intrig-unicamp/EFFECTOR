...
##############################
    ...
    if prot=='tcp':
       test_dict['quic']='off'
       test_dict['url']='https://www.godashbed.org/home/raza/mpds/stl/sintel_enc_x264_dash.mpd'
    else:
       test_dict['quic']='on'
       test_dict['url']='https://www.godashbed.org/home/raza/mpds/sintel_enc_x264_dash.mpd'

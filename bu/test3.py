...
##############################
    ...
    if prot=='tcp':
       test_dict['quic']='off'
       test_dict['url']='https://www.godashbed.org/full/tearsofsteel_enc_x264_dash.mpd'
    else:
       test_dict['quic']='on'
       test_dict['url']='https://www.godashbed.org:4444/full/tearsofsteel_enc_x264_dash.mpd'
